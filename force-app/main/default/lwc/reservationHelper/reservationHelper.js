...
export default class ReservationHelper extends LightningElement 
{
    ...
    connectedCallback() 
    {   
        // The selectCustomer event which was fired by customer tile (not related LWC)
        // is subscribed to and handled by the reservationHelper LWC
    ...
    handleCustomerSelect(event) 
    {
        if (!this.flowStarted) 
        {
            ...
            // This fires an event from this child (lwc) to its parent (aura) reservationHelperAura
            this.dispatchEvent(
